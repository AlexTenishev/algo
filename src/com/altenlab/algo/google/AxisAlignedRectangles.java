 ...
 * Question:  Axis­Aligned  Rectangles
 ...
   Axis‐aligned  means  that  all  the  rectangle  sides  are  either  parallel  or  perpendicular  to  the  x‐  and 
 ...
 and  each  of  the  2*n  iterations  takes  O(log  n)  time.
 */
public class AxisAlignedRectangles {
    public AxisAlignedRectangles() {
